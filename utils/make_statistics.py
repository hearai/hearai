...
if __name__ == "__main__":
    parser = ArgumentParser(description="Generate stats for HamNoSys files")

    parser.add_argument(
        "--file_path",
        type=str,
        help="Path to file, which contains HamNoSys annotations",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--separator",
        default=" ",
        help="Sign, which is used as a separator in the annotation file",
    )

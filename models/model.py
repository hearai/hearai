...
class GlossTranslationModel(pl.LightningModule):
    ...
    def __init__(self, lr=1e-5, 
                ...
                warmup_steps= 100.0,
                transformer_name="transformers/vanilla_trasnformer",
                feature_extractor_name = "feature_extractors/cnn_extractor",
        ...
        # models-parts
        self.feature_extractor = model_loader.create_model(feature_extractor_name)
        self.transformer = model_loader.create_model(transformer_name)
        self.cls_head = nn.Linear(transformer_output_size,
                                  num_classes)

...
class DatasetCreator:
    ...
    def get_train_and_val_dataloaders(self, batch_size: int, workers: int,
                                      num_segments: int, mode: str='random'
